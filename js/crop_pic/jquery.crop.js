	...
	$.fn.crop = function(options){
		...
		image.onload = function(){
			...
			if(box.html()!=''){
				...
				box.after('<table style="position: absolute; top:0;height: 45px;width: 100%;background-image: linear-gradient(120deg, #89f7fe 0%, #66a6ff 100%);position: fixed;z-index: 999;"><td style="width: 45px;float: left;"><a onclick="cancel()" style="color: white;"><img src="../icon/back_white.png" style=" height: 35px;margin-top: 5px;margin-left: 5px;" /></a></table>');
				box.after('<div id="title_text" style="position:absolute;top:5px;left:0px;width:100%;line-height:40px;color:#fff;text-align:center;z-index:12;">设置头像</div><div style="height:'+v.barHeight+'px;width:100%;position:absolute;bottom:0px;"><a class="choose_div"  style="display:none;position:absolute;left:15px;bottom:15px;color:#fff;z-index:12;background-image: linear-gradient(120deg, #89f7fe 0%, #66a6ff 100%);width:60px;height:30px;line-height:30px;text-align:center;border-radius:3px;" id="select_btn">选择</a><a style="display:none;position:absolute;right:15px;bottom:15px;color:#fff;z-index:12;background-image: linear-gradient(120deg, #89f7fe 0%, #66a6ff 100%);width:60px;height:30px;line-height:30px;text-align:center;border-radius:3px;" class="choose_div"  id="edit_finished">完成</a><input type="file" id="selectImageFile" accept="image/*" style="height:0px;width:0px;border:0px;display:none;" /></div>');
